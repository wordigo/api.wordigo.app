...
const WelcomeEmail = ({ username = 'Ali Osman', company = 'Wordigo' }: WelcomeEmailProps) => {
        ...
        <Body className="bg-white my-auto mx-auto font-sans">
          <Container className="my-10 mx-auto p-5 w-[465px]">
            <Section className="mt-8">
              <Img src={`${baseUrl}/images/logo.png`} alt="Logo Example" className="w-60 h-24 my-0 mx-auto" />
            </Section>
